            ...
            <div className="ptb-100">
                <div className="container">
                    <div className={styles.termsOfServiceContent}>
                        ...
                        <p>Our website address is: http://biza.com</p>

                        <blockquote className="blockquote">
                            <p>We collect certain data from you directly like information you enter yourself data about your participation in courses and data from third-party platforms you connect with biza. We also collect some data automatically information about your device and what parts of our Services you interact with or spend time using.</p>
                        </blockquote>
                        ...
                        <ol>
                            ...
                            <li>Sending push notifications to your wireless device to provide updates and other relevant messages (which you can manage from the “options” or “settings” page of mobile app);</li>
                        </ol>
